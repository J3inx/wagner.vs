...
public class setup {
    ...
    public setup(int x) {
        cards = new String[x]; // A standard deck size
        setDeck();
    }
    ...
    public void playBJack() {
        ...
        System.out.println("You currently have: " + bankChanges());
        bet = kb.nextInt();
        shuffle(); // Shuffle before starting the game
 ...
 // Add this method to your setup class:
    ...
    public void Dealer(int action) { 
        if (action == 1) {
            ...
            System.out.println("cpu1 has : " + cpu1Hand.get(0));
            System.out.println("cpu2 has : " + cpu2Hand.get(0));
            System.out.println("cpu3 has : " + cpu3Hand.get(0));
            System.out.println("and the dealer has: " + DealerHand.get(0));
            Dealer(2);
        }
        if(action == 2 && playerStood == false) {
        	if(turns == 0) {
            	...
            	if(card1.charAt(0) == card2.charAt(0)){
            		System.out.println("would you like to split, double, hit, or stand? h/s/sp/d? or type l to list the curent cards on the table");
            		...
            		System.out.println("would you like to hit, double, or stand? h/s/d? or type l to list the curent cards on the table");
            		String choice = kb.next();
                   	if(choice.equalsIgnoreCase("h")) {
                		Dealer(3);
                	}else if(choice.equalsIgnoreCase("s")) {
        	...
        	System.out.println("would you like to hit or stand? h/s? or type l to list the curent cards on the table");
        	String choice = kb.next();
        	if(choice.equalsIgnoreCase("h")) {
        		Dealer(3);
        	}else if(choice.equalsIgnoreCase("s")) {
...
//as of 4/17/25 this is the longest program i've written